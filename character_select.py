...
class CharacterSelect:
    ...
    def __init__(self, window):
        ...
        self.background_image = pygame.image.load(GAME_ASSETS['main_menu_background_blur']).convert()
    ...
    def setup_character_buttons(self):
        ...
        """
        buttons = {}
        total_spacing = 90  # spacing between buttons and edges
        ...
        x = total_spacing
        y = self.window.get_height() // 3 - max_height // 3  # position them a bit higher to make space for back button
